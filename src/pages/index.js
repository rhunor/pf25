...
export default function Home() {
  return (
    <>
      <Head>
        <title>John Rhunor Portfolio Website</title>
        <meta
          name="description"
          content="portfolio website for John Rhunor"
        />
      </Head>
            ...
            <div className="flex w-1/2 flex-col items-center self-center lg:w-full lg:text-center">
              ...
              <div className="flex w-1/2 w-full items-center items-start lg:w-full  lg:!justify-center  sm:!justify-center  md:!text-center md:inline-block md:w-full">
                <h2 className="animate-text bg-gradient-to-r from-lightGreen via-lightGreen to-slideGreen bg-clip-text text-transparent font-semibold capitalize !text-5xl xl:!text-4xl lg:!text-4xl md:!text-5xl sm:!text-3xl">
                  I'm a Mechanical engineer,oil Chemical consultant and i Develop Web Applications.
                </h2>
              </div>

              <p className="my-4 text-base font-medium md:text-sm sm:!text-sm">
                I'm a fullStack web developer, currently working as an oil Chemical consultant
                and website developer and manager. With a
              keen eye for design and a robust understanding of front-end and
                back-end technologies and experience supplying and producing chemicals for numerous production platorms.
              </p>
